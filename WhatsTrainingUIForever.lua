...
local function attachForeverSpellBook(mainFrame)
    EventUtil.ContinueOnAddOnLoaded("Blizzard_PlayerSpells", function()
        ...
        mainFrame:SetPoint("BOTTOMLEFT", book, "BOTTOMLEFT", 65, 35)
        ...
        footer:SetPoint("BOTTOMLEFT", mainFrame, "BOTTOMLEFT", 8, 0)
        mainFrame.count = label(mainFrame, "", "GameFontNormalSmall", 0, 0)
        mainFrame.count:ClearAllPoints()
        mainFrame.count:SetPoint("BOTTOMRIGHT", mainFrame, "BOTTOMRIGHT", -20, 0)
        ...
        scroll:SetPoint("BOTTOMRIGHT", mainFrame, "BOTTOMRIGHT", -20, 28)
