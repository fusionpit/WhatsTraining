...
local function createCategoryRibbon(frame, selectView)
    ...
    bookmark.ribbonGlow = bookmark:CreateTexture(nil, "BACKGROUND", nil, 1)
    bookmark.ribbonGlow:SetTexture("Interface\\AddOns\\WhatsTraining\\ribbon-gold-mask")
    bookmark.ribbonGlow:SetTexCoord(0, 63 / 64, 0, 110 / 128)
    bookmark.ribbonGlow:SetAllPoints(bookmark.art)
    bookmark.ribbonGlow:SetBlendMode("ADD")
    bookmark.ribbonGlow:SetVertexColor(1, 0.8, 0.35)
    bookmark.ribbonGlow:SetAlpha(0)
    ...
    local function updateGlow(self, elapsed)
        ...
        self.ribbonGlow:SetAlpha(alpha * 0.6)
