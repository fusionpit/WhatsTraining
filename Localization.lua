...
local localeText = {
    enUS = {
        ...
        LEDGER_HINT = "Hover a spell for details; <Shift>Click to link",
        LEDGER_EMPTY = "No training spells loaded.",
        LEDGER_CLASS_SPELLS = "Class Spells",
        LEDGER_GROUP_BY = "Group by:",
        LEDGER_GROUP_CITY = "City",
        LEDGER_GROUP_WEAPON = "Weapon",
        LEDGER_SHOW_KNOWN = "Show known",
        LEDGER_WEAPON_HINT = "Hover a skill for details.",
        ...
        LEDGER_WEAPON_LIST_HINT = "Hover a skill or city icon for details.",
