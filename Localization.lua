...
local localeText = {
    enUS = {
        ...
        WEAPON_KNOWN_HEADER = "Already Known Weapon Skills",
        WEAPON_IGNORED_HEADER = "Ignored Weapon Skills",
    ...
    ruRU = {
        AVAILABLE_HEADER = "Доступно сейчас",
        MISSINGREQS_HEADER = "Доступно, но не выполнены требования",
        NEXTLEVEL_HEADER = "Скоро появится",
        NOTLEVEL_HEADER = "Еще недоступно",
        MISSINGTALENT_HEADER = "Не хватает нужных талантов",
        IGNORED_HEADER = "Игнорируемые",
        IGNORED_PET_HEADER = "Игнорируемые (питомец)",
        KNOWN_HEADER = "Уже изучено",
        KNOWN_PET_HEADER = "Уже изучено (питомец)",
        WEAPON_SKILLS_HEADER = "Навыки оружия",
        WEAPON_AVAILABLE_HEADER = "Навыки оружия: доступно сейчас",
        WEAPON_NEXTLEVEL_HEADER = "Навыки оружия: скоро появится",
        WEAPON_NOTLEVEL_HEADER = "Навыки оружия: еще недоступно",
        WEAPON_KNOWN_HEADER = "Уже изученные навыки оружия",
        WEAPON_IGNORED_HEADER = "Игнорируемые навыки оружия",
        PET_HEADER = "Способности питомца",
        COST_FORMAT = "Стоимость: %s",
        TOTALCOST_FORMAT = "Общая стоимость: %s",
        TOTALSAVINGS_FORMAT = "Общая экономия: %s",
        TOTALSPENT_FORMAT = "Всего потрачено: %s",
        BROKER_HEADER_HIDDEN_FORMAT = "Отображается %s (всего %s)",
        BROKER_HIDDEN_FORMAT = "И еще %d стоимостью %s",
        BROKER_NOTHING = "Больше нечему учиться!",
        BROKER_CLICK_BEAST_TRAIN = "Подсказка: Shift+клик, чтобы открыть окно обучения питомца",
        BROKER_CLICK_TOGGLE_WEAPONS = "Подсказка: ПКМ, чтобы скрыть/показать навыки оружия",
        BROKER_CLICK_TOGGLE_SPELLS = "Подсказка: ПКМ, чтобы скрыть/показать заклинания",
        BROKER_CLICK_OPEN = "Подсказка: клик, чтобы открыть книгу заклинаний.",
        BROKER_OPEN_IN_COMBAT = "Нельзя открыть книгу заклинаний в бою",
        OPEN_BEAST_IN_COMBAT = "Нельзя открыть обучение питомца в бою",
        LEVEL_FORMAT = "Уровень %s",
        TAB_TEXT = "Чему я могу научиться?",
        OPEN_BEAST_TRAINING = "Пожалуйста, откройте окно обучения питомца",
        CLICK_TO_OPEN = "Кликните, чтобы открыть обучение питомца",
        TOME_HEADER = "Было ли это изучено?",
        TOME_LEARNED = "Фолиант изучен",
        NEW_IGNORE_FEATURE = "ПКМ, чтобы игнорировать способности",
        IGNORED_TT = "Игнорируется",
        IGNORE_ALL_TT = "Игнорировать все ранги",
        SEARCH_NO_RESULTS = "Ничего не найдено",
        INCUBUS = "Инкуб",
        NOT_KNOWN = "Не изучено",
        SETTINGS = "Настройки",
        SHOW_WEAPONS = "Показывать навыки оружия",
        SHOW_SPELLS = "Показывать заклинания",
        TRAINED_IN = "Обучает в: %s",
        OR = " или ",
        GROUP_BY_ZONE = "Группировать по зонам",
        GROUP_BY_WEAPON_SKILL = "Группировать по навыкам оружия",
        GROUP_LIST = "Список",
        GROUPING_OPTIONS = "Параметры отображения",
        GROUPING_OPTIONS_TITLE = "Отображение навыков оружия:",
        WAYPOINT_SET = "Точка маршрута установлена",
        CLICK_TO_WAYPOINT = "Кликните, чтобы установить точку на карте",
    },
    zhCN = {
