...
ClassSpellsByLevel["Warlock"] = {
	[1] = {
		{id=687,name="Demon Armor",subText="Rank 1",level=1,icon="Interface\\Icons\\Spell_Shadow_RagingScream"},
	...
	[4] = {
		{id=702,name="Curse of Weakness",subText="",level=4,icon="Interface\\Icons\\Spell_Shadow_CurseOfMannoroth"},
	...
	[10] = {
		{id=696,name="Demon Armor",subText="Rank 2",level=10,icon="Interface\\Icons\\Spell_Shadow_RagingScream",requiredIds={687}},
	...
	[12] = {
		{id=1108,name="[Deprecated] Curse of Weakness",subText="Rank 2",level=12,icon="Interface\\Icons\\Spell_Shadow_CurseOfMannoroth"},
	...
	[20] = {
		{id=706,name="Demon Armor",subText="Rank 3",level=20,icon="Interface\\Icons\\Spell_Shadow_RagingScream",requiredIds={696}},
		...
		{id=17877,name="Shadowburn",subText="Rank 1",level=20,icon="Interface\\Icons\\Spell_Shadow_ScourgeBuild",requiredTalent={id=326,tabIndex=3}},
		{id=48017,name="Summon Incubus",subText="Summon",level=20,icon="Interface\\Icons\\ability_warlock_incubus"}
	},
	[22] = {
		{id=6205,name="[Deprecated] Curse of Weakness",subText="Rank 3",level=22,icon="Interface\\Icons\\Spell_Shadow_CurseOfMannoroth",requiredIds={1108}},
		...
		{id=51691,name="Firestone Attack",subText="",level=22,icon="Interface\\Icons\\Spell_Shadow_ShadowBolt"},
		{id=51692,name="Create Firestone",subText="",level=22,icon="Interface\\Icons\\INV_Ammo_FireTar"}
	},
	[24] = {
	...
	[30] = {
		...
		{id=1086,name="Demon Armor",subText="Rank 4",level=30,icon="Interface\\Icons\\Spell_Shadow_RagingScream",requiredIds={706}},
		...
		{id=6353,name="Soul Fire",subText="Rank 1",level=30,icon="Interface\\Icons\\Spell_Fire_Fireball02"},
		{id=709,name="Drain Life",subText="Rank 3",level=30,icon="Interface\\Icons\\Spell_Shadow_LifeDrain02",requiredIds={699}},
		{id=18265,name="Siphon Life",subText="Rank 1",level=30,icon="Interface\\Icons\\Spell_Shadow_Requiem",requiredTalent={id=348,tabIndex=1}},
		...
		{id=51714,name="Power Overwhelming",subText="",level=30,icon="Interface\\Icons\\ability_warlock_power_overwhelming",requiredTalent={id=366,tabIndex=2}}
	},
	[32] = {
		{id=1490,name="Curse of the Elements",subText="Rank 1",level=32,icon="Interface\\Icons\\Spell_Shadow_ChillTouch"},
		{id=7646,name="[Deprecated] Curse of Weakness",subText="Rank 4",level=32,icon="Interface\\Icons\\Spell_Shadow_CurseOfMannoroth",requiredIds={6205}},
		...
		{id=51698,name="Create Felstone",subText="",level=32,icon="Interface\\Icons\\inv_misc_gem_felstone"}
	},
	[34] = {
	...
	[38] = {
		...
		{id=17924,name="Soul Fire",subText="Rank 2",level=38,icon="Interface\\Icons\\Spell_Fire_Fireball02",requiredIds={6353}},
	...
	[40] = {
		{id=11733,name="Demon Armor",subText="Rank 5",level=40,icon="Interface\\Icons\\Spell_Shadow_RagingScream",requiredIds={1086}},
		...
		{id=17962,name="Conflagrate",subText="Rank 1",level=40,icon="Interface\\Icons\\Spell_Fire_Fireball",requiredTalent={id=335,tabIndex=3}},
		{id=18220,name="Dark Pact",subText="Rank 1",level=40,icon="Interface\\Icons\\Spell_Shadow_DarkRitual"},
		...
		{id=52550,name="Dark Harvest",subText="Rank 1",level=40,icon="Interface\\Icons\\Spell_Shadow_SoulLeech",requiredTalent={id=352,tabIndex=1}},
	...
	[42] = {
		...
		{id=11707,name="[Deprecated] Curse of Weakness",subText="Rank 5",level=42,icon="Interface\\Icons\\Spell_Shadow_CurseOfMannoroth",requiredIds={7646}},
		...
		{id=51701,name="Create Wrathstone",subText="",level=42,icon="Interface\\Icons\\INV_Misc_Gem_Bloodstone_02"}
	},
	[44] = {
	...
	[46] = {
		...
		{id=51683,name="Soul Fire",subText="Rank 3",level=46,icon="Interface\\Icons\\Spell_Fire_Fireball02",requiredIds={17924}}
	},
	[48] = {
	...
	[50] = {
		...
		{id=11734,name="Demon Armor",subText="Rank 6",level=50,icon="Interface\\Icons\\Spell_Shadow_RagingScream",requiredIds={11733}},
		...
		{id=52551,name="Dark Harvest",subText="Rank 2",level=50,icon="Interface\\Icons\\Spell_Shadow_SoulLeech",requiredIds={52550}}
	},
	[52] = {
		{id=11708,name="[Deprecated] Curse of Weakness",subText="Rank 6",level=52,icon="Interface\\Icons\\Spell_Shadow_CurseOfMannoroth",requiredIds={11707}},
		...
		{id=51695,name="Create Spellstone",subText="",level=52,icon="Interface\\Icons\\INV_Misc_Gem_Sapphire_01"}
	},
	[54] = {
		...
		{id=51684,name="Soul Fire",subText="Rank 4",level=54,icon="Interface\\Icons\\Spell_Fire_Fireball02",requiredIds={51683}}
	},
	[56] = {
	...
	[60] = {
		...
		{id=11735,name="Demon Armor",subText="Rank 7",level=60,icon="Interface\\Icons\\Spell_Shadow_RagingScream",requiredIds={11734}},
		...
		{id=18541,name="Ritual of Doom Effect",subText="",level=60,icon="Interface\\Icons\\Spell_Arcane_PortalDarnassus"},
		...
		{id=52552,name="Dark Harvest",subText="Rank 3",level=60,icon="Interface\\Icons\\Spell_Shadow_SoulLeech",requiredIds={52551}},
		{id=45908,name="Demon Gate",subText="",level=60,icon="Interface\\Icons\\Spell_Shadow_SummonFelGuard"},
		{id=51687,name="Drain Soul",subText="Rank 5",level=60,icon="Interface\\Icons\\Spell_Shadow_Haunting",requiredIds={11675}}
	}
}