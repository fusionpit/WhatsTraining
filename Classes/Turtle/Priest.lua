...
ClassSpellsByLevel["Priest"] = {
	...
	[10] = {
		...
		{id=13908,name="Desperate Prayer",subText="Rank 1",level=10,icon="Interface\\Icons\\Spell_Holy_Restoration",races={"Dwarf","Human"}},
	...
	[18] = {
		...
		{id=19236,name="Desperate Prayer",subText="Rank 2",level=18,icon="Interface\\Icons\\Spell_Holy_Restoration",races={"Dwarf","Human"},requiredIds={13908}},
	...
	[20] = {
		...
		{id=15237,name="Holy Nova",subText="Rank 1",level=20,icon="Interface\\Icons\\Spell_Holy_HolyNova",requiredTalent={id=192,tabIndex=2}},
		{id=14914,name="Holy Fire",subText="Rank 1",level=20,icon="Interface\\Icons\\Spell_Holy_SearingLight"},
		{id=15407,name="Mind Flay",subText="Rank 1",level=20,icon="Interface\\Icons\\Spell_Shadow_SiphonMana",requiredTalent={id=207,tabIndex=3}},
		{id=6346,name="Fear Ward",subText="",level=20,icon="Interface\\Icons\\Spell_Holy_Excorcism"},
		...
		{id=52638,name="Searing Shot",subText="Rank 1",level=20,icon="Interface\\Icons\\Ability_SearingArrow",races={"Night Elf"}},
	...
	[26] = {
		...
		{id=19238,name="Desperate Prayer",subText="Rank 3",level=26,icon="Interface\\Icons\\Spell_Holy_Restoration",races={"Dwarf","Human"},requiredIds={19236}},
	...
	[30] = {
		...
		{id=15286,name="Vampiric Embrace",subText="",level=30,icon="Interface\\Icons\\Spell_Shadow_UnsummonBuilding",requiredTalent={id=213,tabIndex=3}},
		{id=15487,name="Silence",subText="",level=30,icon="Interface\\Icons\\Spell_Shadow_ImpPhaseShift",requiredTalent={id=212,tabIndex=3}},
		...
		{id=724,name="Lightwell",subText="Rank 1",level=30,icon="Interface\\Icons\\Spell_Holy_SummonLightwell"},
		{id=7001,name="Lightwell Renew",subText="Rank 1",level=30,icon="Interface\\Icons\\Spell_Holy_SummonLightwell"},
		{id=45555,name="Pain Spike",subText="Rank 1",level=30,icon="Interface\\Icons\\Spell_Shadow_PainSpike"},
		{id=51476,name="Enlighten",subText="",level=30,icon="Interface\\Icons\\btnholyscriptures",requiredTalent={id=180,tabIndex=1}}
	},
	[32] = {
		...
		{id=52640,name="Searing Shot",subText="Rank 2",level=32,icon="Interface\\Icons\\Ability_SearingArrow",races={"Night Elf"},requiredIds={52638}}
	},
	[34] = {
		...
		{id=19240,name="Desperate Prayer",subText="Rank 4",level=34,icon="Interface\\Icons\\Spell_Holy_Restoration",races={"Dwarf","Human"},requiredIds={19238}},
	...
	[40] = {
		...
		{id=15473,name="Shadowform",subText="",level=40,icon="Interface\\Icons\\Spell_Shadow_Shadowform",requiredTalent={id=216,tabIndex=3}},
		...
		{id=10060,name="Power Infusion",subText="",level=40,icon="Interface\\Icons\\Spell_Holy_PowerInfusion"},
		{id=27870,name="Lightwell",subText="Rank 2",level=40,icon="Interface\\Icons\\Spell_Holy_SummonLightwell",requiredIds={724}},
		{id=45562,name="Proclaim Champion",subText="",level=40,icon="Interface\\Icons\\Spell_Holy_ProclaimChampion_02",requiredTalent={id=199,tabIndex=2}},
		{id=45563,name="Champion's Grace",subText="",level=40,icon="Interface\\Icons\\Spell_Holy_ChampionsGrace"},
		{id=45569,name="[Deprecated] Champion's Resolve",subText="",level=40,icon="Interface\\Icons\\Spell_Holy_ProclaimChampion"},
		{id=57701,name="Pain Spike",subText="Rank 2",level=40,icon="Interface\\Icons\\Spell_Shadow_PainSpike",requiredIds={45555}},
		{id=51478,name="Chastise",subText="Rank 1",level=40,icon="Interface\\Icons\\Spell_Holy_UnyieldingFaith",requiredTalent={id=183,tabIndex=1}}
	},
	[42] = {
		...
		{id=19241,name="Desperate Prayer",subText="Rank 5",level=42,icon="Interface\\Icons\\Spell_Holy_Restoration",races={"Dwarf","Human"},requiredIds={19240}},
	...
	[44] = {
		...
		{id=52642,name="Searing Shot",subText="Rank 3",level=44,icon="Interface\\Icons\\Ability_SearingArrow",races={"Night Elf"},requiredIds={52640}}
	},
	[45] = {
		{id=51479,name="Chastise",subText="Rank 2",level=45,icon="Interface\\Icons\\Spell_Holy_UnyieldingFaith",requiredIds={51478}}
	},
	[46] = {
	...
	[50] = {
		...
		{id=19242,name="Desperate Prayer",subText="Rank 6",level=50,icon="Interface\\Icons\\Spell_Holy_Restoration",races={"Dwarf","Human"},requiredIds={19241}},
		...
		{id=27871,name="Lightwell",subText="Rank 3",level=50,icon="Interface\\Icons\\Spell_Holy_SummonLightwell",requiredIds={27870}},
		{id=45565,name="Empower Champion",subText="Rank 1",level=50,icon="Interface\\Icons\\Spell_Holy_EmpowerChampion"},
		{id=57704,name="Pain Spike",subText="Rank 3",level=50,icon="Interface\\Icons\\Spell_Shadow_PainSpike",requiredIds={57701}},
	...
	[55] = {
		{id=51480,name="Chastise",subText="Rank 3",level=55,icon="Interface\\Icons\\Spell_Holy_UnyieldingFaith",requiredIds={51479}}
	},
	[56] = {
	...
	[58] = {
		...
		{id=19243,name="Desperate Prayer",subText="Rank 7",level=58,icon="Interface\\Icons\\Spell_Holy_Restoration",races={"Dwarf","Human"},requiredIds={19242}},
		...
		{id=52644,name="Searing Shot",subText="Rank 4",level=58,icon="Interface\\Icons\\Ability_SearingArrow",races={"Night Elf"},requiredIds={52642}}
	},
	[60] = {
		...
		{id=52646,name="Searing Shot",subText="Rank 5",level=60,icon="Interface\\Icons\\Ability_SearingArrow",races={"Night Elf"},requiredIds={52644}},
		{id=57707,name="Pain Spike",subText="Rank 4",level=60,icon="Interface\\Icons\\Spell_Shadow_PainSpike",requiredIds={57704}},
		...
		{id=51458,name="Lightwell",subText="Rank 4",level=60,icon="Interface\\Icons\\Spell_Holy_SummonLightwell",requiredIds={27871}}
	}
}