...
ClassSpellsByLevel["Hunter"] = {
	...
	[10] = {
		...
		{id=45650,name="Aspect of the Wolf",subText="Rank 1",level=10,icon="Interface\\Icons\\Ability_Mount_WhiteDireWolf"}
	},
	[12] = {
	...
	[18] = {
		...
		{id=51496,name="Aspect of the Wolf",subText="Rank 2",level=18,icon="Interface\\Icons\\Ability_Mount_WhiteDireWolf",requiredIds={45650}}
	},
	[20] = {
		...
		{id=51575,name="Carve",subText="",level=20,icon="Interface\\Icons\\INV_ThrowingKnife_06",requiredTalent={id=396,tabIndex=3}}
	},
	[22] = {
		{id=3043,name="Scorpid Sting",subText="",level=22,icon="Interface\\Icons\\Ability_Hunter_CriticalShot"},
	...
	[28] = {
		...
		{id=51497,name="Aspect of the Wolf",subText="Rank 3",level=28,icon="Interface\\Icons\\Ability_Mount_WhiteDireWolf",requiredIds={51496}}
	},
	[30] = {
		{id=13161,name="Aspect of the Beast",subText="",level=30,icon="Interface\\Icons\\Ability_Mount_PinkTiger"},
		{id=5384,name="Feign Death",subText="",level=30,icon="Interface\\Icons\\Ability_Rogue_FeignDeath"},
	...
	[38] = {
		...
		{id=45970,name="Steady Shot",subText="Rank 6",level=38,icon="Interface\\Icons\\Ability_Hunter_SteadyShot"},
		{id=45972,name="Steady Shot",subText="Rank 7",level=38,icon="Interface\\Icons\\Ability_Hunter_SteadyShot",requiredIds={45970}},
		{id=51498,name="Aspect of the Wolf",subText="Rank 4",level=38,icon="Interface\\Icons\\Ability_Mount_WhiteDireWolf",requiredIds={51497}}
	},
	[40] = {
	...
	[42] = {
		...
		{id=14276,name="[Deprecated] Scorpid Sting",subText="Rank 3",level=42,icon="Interface\\Icons\\Ability_Hunter_CriticalShot",requiredIds={14275}},
	...
	[52] = {
		...
		{id=14277,name="[Deprecated] Scorpid Sting",subText="Rank 4",level=52,icon="Interface\\Icons\\Ability_Hunter_CriticalShot",requiredIds={14276}},
	...
	[58] = {
		...
		{id=51500,name="Aspect of the Wolf",subText="Rank 6",level=58,icon="Interface\\Icons\\Ability_Mount_WhiteDireWolf",requiredIds={51499}}
	},
	[60] = {
		...
		{id=45974,name="Steady Shot",subText="Rank 8",level=60,icon="Interface\\Icons\\Ability_Hunter_SteadyShot",requiredIds={45972}},
		{id=51501,name="Aspect of the Wolf",subText="Rank 7",level=60,icon="Interface\\Icons\\Ability_Mount_WhiteDireWolf",requiredIds={51500}}
	}
}